...
import { dayOfWeekEnum } from "../databases/entities/day-availability";
import { Event } from "../databases/entities/event.entity";
...
export const getUserAvailabilityService = async (userId: string) => {
  ...
  if (!user || !user.availability) {
    throw new NotFoundException("User or Availability not found");
  }
...
export const getUserAvailabilityForPublicEventsService = async (
  eventId: string
) => {
